...
def predict_priority(model_bundle: dict, cleaned_text: str) -> str:
    """Predict the manager-facing urgency level."""
    return model_bundle["priority_classifier"].predict([cleaned_text])[0]
