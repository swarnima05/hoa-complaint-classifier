...
HOA management teams often receive maintenance complaints from residents in plain English. Operations managers otherwise need to manually read each complaint, decide whether it is plumbing, electrical, elevator, landscaping, cleanliness, or security related, estimate urgency, and contact the right responder.

This project automates that first triage step so complaints can move faster from resident report to service dispatch.

## UI Preview

<img width="1280" height="660" alt="dashboard" src="https://github.com/user-attachments/assets/b7162d9b-4d46-450d-aa08-7a23164dd428" />
